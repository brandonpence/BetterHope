...
class Bunyad_Admin_Importer
{
	...
	public function start_importer()
	{
		...
		<?php if (stristr($xml_result, 'All Done')): ?>
			...
			<p><?php _e('Your import has been completed successfully. Have fun!', 'bunyad'); ?></p>

		<?php else: ?>

			<h3 class="failed"><?php _e('Import Failed!', 'bunyad'); ?></h3>
			<p><?php _e('Sorry but your import failed. Most likely, it cannot work with your webhost. You will have to ask your webhost to increase your PHP max_execution_time (or any other webserver timeout to at least 300 secs) and memory_limit (to at least 196M) temporarily.', 'bunyad'); ?></p>
