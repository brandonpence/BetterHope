...
class Bunyad_Theme_SmartMag_WooCommerce
{
	...
	public function cart_menu_link()
	{
		...
		?>
			...
			<a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" class="cart-link"><i class="fa fa-shopping-cart"></i><span class="counter<?php echo ($count ? ' active' : ''); ?>"><?php echo $count; ?></span></a>
